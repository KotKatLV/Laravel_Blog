...
class PostController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if ($post->author_id !== Auth::user()->id) {
            return redirect()->route('post.index')->withErrors('вы неможете редактировать данный пост');
        }
    ...
    public function destroy($id)
    {
        $post = Post::find($id);
        if ($post->author_id !== Auth::user()->id) {
            return redirect()->route('post.index')->withErrors('вы неможете удалить данный пост');
        }
        $post->delete();
